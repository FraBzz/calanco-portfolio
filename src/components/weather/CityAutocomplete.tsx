    ...
    <form onSubmit={(e) => {
      ...
      <div className="relative">
        ...
        <input
          ...
          className="pl-10 w-full p-3 bg-background-dark border border-separator-dark rounded-md"
        />
        {showSuggestions && suggestions.length > 0 && (
          <div
            ref={suggestionRef}
            className="absolute z-10 w-full mt-1 bg-background-dark border border-separator-dark rounded-md shadow-lg"
          >
